...
import com.etherblood.cardsmatch.cardgame.TemplateLoader;
...
public class DefaultTemplateSetFactory {
    ...
    public static final String SERVER_TEMPLATES_PATH = System.getProperty("user.home") + System.getProperty("file.separator") + "etherblood" + System.getProperty("file.separator") + "templates.xml";
    ...
    public TemplateSet createEntityTemplates() {
        
        for (EntityTemplate entityTemplate : new TemplateLoader().read(SERVER_TEMPLATES_PATH)) {
