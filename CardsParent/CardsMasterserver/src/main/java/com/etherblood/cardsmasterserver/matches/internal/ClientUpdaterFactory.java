...
public class ClientUpdaterFactory {
    public static HashMap<Class, UpdateBuilder> createUpdateBuilders() {
        ...
        updateBuilders.put(BoardAttachSystem.class, new UpdateBuilder<BoardAttachEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, BoardAttachEvent event) {
        ...
        updateBuilders.put(HandAttachSystem.class, new UpdateBuilder<HandAttachEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, HandAttachEvent event) {
        ...
        updateBuilders.put(GraveyardAttachSystem.class, new UpdateBuilder<GraveyardAttachEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, GraveyardAttachEvent event) {
        ...
        updateBuilders.put(BoardDetachSystem.class, new UpdateBuilder<BoardDetachEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, BoardDetachEvent event) {
        ...
        updateBuilders.put(HandDetachSystem.class, new UpdateBuilder<HandDetachEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, HandDetachEvent event) {
                return new SetZone(converter.toLong(event.target), CardZone.None.ordinal());
            }
        });
        ...
        updateBuilders.put(SetOwnerSystem.class, new UpdateBuilder<SetOwnerEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, SetOwnerEvent event) {
        ...
        updateBuilders.put(SetHealthSystem.class, new UpdateBuilder<SetHealthEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, SetHealthEvent event) {
        ...
        updateBuilders.put(EndMatchSystem.class, new UpdateBuilder<PlayerLostEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, PlayerLostEvent event) {
                return new GameOver(converter.toLong(match.data.entities(WinnerComponent.class).iterator().next()));
            }
        });
        
        updateBuilders.put(SetManaSystem.class, new UpdateBuilder<SetManaEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, SetManaEvent event) {
                for (EntityId hero : heroQuery.list(match.data)) {
                    if(match.data.get(hero, OwnerComponent.class).player == event.entity) {
...
//        });
        ...
        updateBuilders.put(DeleteEntitySystem.class, new UpdateBuilder<DeleteEntityEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, DeleteEntityEvent event) {
        ...
        updateBuilders.put(ApplyAttackSystem.class, new UpdateBuilder<AttackEvent>() {
            @Override
            public MatchUpdate build(MatchState match, IdConverter converter, AttackEvent event) {
